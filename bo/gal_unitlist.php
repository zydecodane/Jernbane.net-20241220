...
<div id="gal_breadcrum">
	...
	<a href="<?php echo $path; ?>subpage.php?s=2&k=<?php echo $type[1]; ?>" target="_parent" class="galsearch" onfocus="if(this.blur)this.blur()"><?php echo htmlspecialchars($kat[0]); ?></a> >
	<a href="<?php echo $path; ?>subpage.php?s=3&t=<?php echo $typeid; ?>" target="_parent" class="galsearch" onfocus="if(this.blur)this.blur()"><?php echo htmlspecialchars($type[0]); ?></a>
	<hr />
	<div class="mobile">
...
<div class="gal_container">
	...
	<div id="index_right">
		<div class="gal_heading">
			<?php echo htmlspecialchars($type[0]); ?>
	</div>
...
<div class="nyunit_headline">
    <?php echo htmlspecialchars($unit[1]); 
    ?>
</div>

<!-- start mobilvisning -->
<div class="nyunit_text mobile_show">
  I alt <?php echo $n; ?> bilde<?php if($n>1){echo"r";} ?> - <a href="subpage.php?s=4&amp;u=<?php echo $unit[0]; ?>" class="nygal"><?php if ($n<=1) { ?><b>se detaljer</b></a><?php } ?><?php if ($n>1) { ?><b>se alle</b></a><?php } ?>
</div>
	...
	<div class="nygal_imgtext">
     ...
     <div class="nygal_imgbund">
			...
			<div class="nygal_searchicon">
				<?php
					$slutp = strrpos($m_img[6],'.',$offset = 0 ); // filtrerer .jpg fra strengen
				?>
				<a href="../forum/search/?q=<?php echo substr($m_img[6],0,$slutp);?>"><img src="../bo/graphics/search.jpg" title="Søk etter bildet i Forumene" alt="Søk etter bildet i Forumene"/></a>
			</div>
		</div>
    </div>
...
<div class="nyunit_text mobile">
  I alt <?php echo $n; ?> bilde<?php if($n>1){echo"r";} ?> - <a href="subpage.php?s=4&amp;u=<?php echo $unit[0]; ?>" class="nygal"><?php if ($n<=3){ ?> <b>se detaljer</b> <?php } ?><?php if ($n>3){ ?> <b>se alle</b> <?php } ?> </a>
</div>
...
?>
	<div class="nygal_imgtext">
     ...
     <div class="nygal_imgbund">
			...
			<div class="nygal_searchicon">
				<?php
					$slutp = strrpos($img[6],'.',$offset = 0 ); // filtrerer .jpg fra strengen
				?>
				<a href="../forum/search/?q=<?php echo substr($img[6],0,$slutp);?>"><img src="../bo/graphics/search.jpg" title="Søk etter bildet i Forumene" alt="Søk etter bildet i Forumene"/></a>
			</div>
		</div>
    </div>
<?php
...
<div class="nyunit_text mobile">
<!-- Visar inte infotext på översiktssidan 
  <?php //echo $tekst; ?>
<br /><br />
-->
...
<?php if ($loggedin == 1) { ?>
<!--
	<a href="#" class="nygal" onclick="TINY.box.show({url:'../bo/infocontainer.php?id=<?php echo $unit[0]; ?>&amp;u=<?php echo $userid; ?>&amp;t=<?php echo $typeid; ?>',width:800,height:410,opacity:50,close:false})" style="cursor:pointer">Legg til informasjon om <?php echo htmlspecialchars($type[0]); echo " - "; echo htmlspecialchars($unit[1]); ?></a>
-->	
	<br /><br />
<?php } ?>
</div>
...
<br /><br />
<?php if ($loggedin == 1) { ?>
	<a href="#" class="nygal" onclick="TINY.box.show({url:'../bo/infocontainer.php?id=<?php echo $unit[0]; ?>&amp;u=<?php echo $userid; ?>&amp;t=<?php echo $typeid; ?>',width:800,height:410,opacity:50})" style="cursor:pointer">Legg til informasjon om <?php echo htmlspecialchars($type[0]); echo " - "; echo htmlspecialchars($unit[1]); ?></a>
	<br /><br />
<?php } ?>
</div>
