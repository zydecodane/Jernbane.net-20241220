...
$premium = $db2->query("select 1 AS tender from xf_user_group_relation where (user_group_id =14 or user_group_id = 3) and user_id = '$userid'")->fetch_object()->tender;
...
<table callpadding="0" cellspacing="0" border="0" width="100%">
 <tr>
  ...
  <td>
    ...
    <input type="submit" value="Last opp !" class="button15" />
  </td>
 </tr>
 </table> 
<br /><br />
