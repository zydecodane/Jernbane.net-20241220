...
function search_param($filename) {
	return urlencode(str_replace(" ", "%20", pathinfo($filename, PATHINFO_FILENAME)));
	//return urlencode('"'.pathinfo($filename, PATHINFO_FILENAME).'" '.urlencode(pathinfo($filename, PATHINFO_FILENAME)));
}
...
<!--						<div class="nygal_searchicon">
						...
						<div class="nygal_searchicon">
								<a href="../forum/search?q=<?php echo search_param($image[6]); ?>"><img src="../bo/graphics/search.jpg" title="Finn i Postvogna" alt="Finn i Postvogna"/></a>
						</div>
					</div>
	    	</div>
