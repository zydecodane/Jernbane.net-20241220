...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyAkyszLP9B_TYF988njb9PJzxV9fiF8fP8&sensor=false"></script>
<style type="text/css">
...
<?php
 include('config.php');
 if (isset($_GET['z'])) { $zoom=$_GET['z'];} else { $zoom=6;}
...
<body style="margin:0px; padding:0px;" onload="initialize()">
    <div id="map_canvas" style="width: 1260px; height: 600px"></div>
	
	  <form id="gmaplatlon" method="post" action=""><fieldset style="border:0px; padding:0px;"><legend style="display:none;">&nbsp;</legend><input type="hidden" name="gmaplatlon" value="true"><p>
  <table><tr>
  <td><span id="latitudeError"></span><label for="latitude"><b>Latitude:</b></label></td><td><input type="text" id="latitude" name="latitude" style="width:150px;" maxlength="50"></td>
  </tr><tr>
  <td><span id="longitudeError"></span><label for="longitude"><b>Longitude:</b></label></td><td><input type="text" id="longitude" name="longitude" style="width:150px;" maxlength="50"></td>
  </tr><tr>
  <td><span id="zoomError"></span><label for="zoom"><b>Zoom:</b></label></td><td><input type="text" id="zoom" name="zoom" style="width:25px;" maxlength="50"></td>
  </tr><tr>
  <td><span id="urlError"></span><label for="url"><b>LINK:</b></label></td><td><input type="text" id="url" name="url" style="width:700px;" maxlength="50"></td></fieldset>
  </tr></table></form>
