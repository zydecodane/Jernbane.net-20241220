...
<div id="show_main">
	...
	<div class="mobile">
      ...
      <?php  
      	if ($ispremiumclass > 0) { ?>
 	   <img src="<?php echo $img[25]; ?>" alt="copyright <?php echo $img[5]; ?>" title="copyright <?php echo $img[5]; ?>" class="m_img" />
      <?php }
      else { ?>
       <img src="<?php echo $img[26]; ?>" style="border: 1px solid #800000;" alt="copyright <?php echo $img[5]; ?>" title="copyright <?php echo $img[5]; ?>" />
      <?php } ?>
      </div>
      <div class="mobile">
      	<br />
...
<div style="display: table; vertical-align: top; width: 100%;">
	...
	<div id="show_textcontainer">
			...
			<br /><br />
			<b>Fotograf:</b><br /><?php echo $img[5]; ?>
			<br /><br />
			<b>EXIF-data:</b>
			<br />
		<?php
		...
		<b>Antall visninger:</b> <?php echo $count; ?><br /> <br /> 
		...
		for ($mg = 0 ; $mg<$ng ; $mg++) {
			...
			echo $typeid[$mg]." ".$nummer[$mg]." " .$detailid[$mg]." ".$detail[$mg]
		?>
		 ...
		 > <a href="<?php echo $path; ?>subpage.php?s=999&d=<?php echo $detailid[$mg]; ?>" target="_parent" class="galsearch" onfocus="if(this.blur)this.blur()"><?php echo $detail[$mg]; ?></a>
		 <br />
		 <?php } ?>
		<?php
		}
