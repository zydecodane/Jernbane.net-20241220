	...
	<br /><br />
		...
		<div class="cat_box">
			...
			<?php } ?>
				...
				<form name="catreset" method="post" action="index.php?s=6&id=<?php echo $id; ?>&r=1&page=<?php echo $page; ?>&eg=<?php echo $eg.$ae_parstr; ?>&fi=<?php echo $fi; ?>">   
				   <input type="hidden" name="logid" value="<?php echo $logid; ?>" />
