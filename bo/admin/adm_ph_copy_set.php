...
$timenow = date('U');
$query = "INSERT INTO gal_images (url, thumb, navn, tekst, fotograf, dato, bruker, ip, type, nummer, kamera, kameramodel, lukkertid, blender, iso, focal, posthylla, latitude, longitude, timestamp, modify_time, clean_url, clean_thumb, detailid) VALUES ('$img[1]','$img[2]','$img[3]','$img[4]','$img[5]','$img[6]','$img[7]','$img[8]','$type','$unit','$img[13]','$img[14]','$img[15]','$img[16]','$img[17]','$img[18]','1','$img[21]','$img[22]','0', '$timenow','$img[25]','$img[26]',IF('$unitdetail' = 0, NULL, '$unitdetail'))";
