...
<tr id="<?php echo $liste3[0]; ?>" class="anchor">
  ...
  <td >
    <input type="text" name="t<?PHP echo $n; ?>" style="width: 390px; border: 0px;" value="<?PHP echo htmlspecialchars($liste3[1]); ?>" />
  ...
  <td width=100><a href="index.php?s=3&amp;p=5&amp;l=<?php echo $land; ?>&amp;c=<?php echo $cat; ?>&amp;t=<?php echo $type;?>&amp;u=<?php echo $liste3[0]; ?>" style="color: blue;">rediger detaljer</a>
  </td>
  <td >
