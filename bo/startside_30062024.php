...
{ ?>
	<div class="gal_container">
		<div>
			...
			<div class="nygal_content1" style="padding-left: 0px;">
				<?php
				$query = "select * from gal_images where posthylla = '1' and poeng > 30 order by RAND() LIMIT 1";	
				$result2 = $db->query($query);
				while ( $img = $result2->fetch_array() ) {
				 ?>				 
			 	<div id="show_header" style="width: 1202px; margin-left: auto; margin-right:auto; ">		 	    
			 	    <?php
			 	      if($img[12]>0) { $stars=round(($img[11]/$img[12])); } else { $stars=0;}
			 	    ?>
			 	    <div id="show_top_starcontainer" style="width: 1202px; padding-left: 20px;"><img src="graphics/<?php echo $stars; ?>stars.gif" alt="" /></div> 
			 	    	<img src="graphics/jernbanenet_h28.gif" alt="" class="logo_align" />
			 		</div>
			    	<div id="show_imgcontainer" style="width: 1200px; text-align: text-align: center !important; margin-left: auto; margin-right:auto;">
						<div style="text-align: center;">
			       	 		<a href="subpage.php?s=100&id=<?php echo $img[0]; ?>"><img src="<?php echo $img[1]; ?>" alt="copyright <?php echo $img[5]; ?>" title="copyright <?php echo $img[5]; ?>" style="align: center;" /></a>  
						</div> 
			       </div>
			       <br /> 
				<?php } ?> 
