...
$query="INSERT INTO gal_images (url, thumb, navn, tekst, fotograf, dato, bruker, ip, type, nummer, kamera, kameramodel, lukkertid, blender, iso, focal, posthylla, latitude, longitude, timestamp, clean_url, clean_thumb) VALUES ('$url1','$thumb1','$newfile1','$tekst1','$photographer1','$date1','$user','$ip','$type1','$unit1','$camera1','$model1','$shutter1','$aperture1','$iso1','$focal1','$gallery','$lat1','$lon1','$datetime','$clean_url1','$clean_thumb1')";
...
$query2="INSERT INTO gal_images (url, thumb, navn, tekst, fotograf, dato, bruker, ip, type, nummer, kamera, kameramodel, lukkertid, blender, iso, focal, posthylla, latitude, longitude, timestamp, clean_url, clean_thumb) VALUES ('$url2','$thumb2','$newfile2','$tekst2','$photographer2','$date2','$user','$ip','$type2','$unit2','$camera2','$model2','$shutter2','$aperture2','$iso2','$focal2','$gallery','$lat2','$lon2','$datetime','$clean_url2','$clean_thumb2')";
...
$query3="INSERT INTO gal_images (url, thumb, navn, tekst, fotograf, dato, bruker, ip, type, nummer, kamera, kameramodel, lukkertid, blender, iso, focal, posthylla, latitude, longitude, timestamp, clean_url, clean_thumb) VALUES ('$url3','$thumb3','$newfile3','$tekst3','$photographer3','$date3','$user','$ip','$type3','$unit3','$camera3','$model3','$shutter3','$aperture3','$iso3','$focal3','$gallery','$lat3','$lon3','$datetime','$clean_url3','$clean_thumb3')";
...
$query4="INSERT INTO gal_images (url, thumb, navn, tekst, fotograf, dato, bruker, ip, type, nummer, kamera, kameramodel, lukkertid, blender, iso, focal, posthylla, latitude, longitude, timestamp, clean_url, clean_thumb) VALUES ('$url4','$thumb4','$newfile4','$tekst4','$photographer4','$date4','$user','$ip','$type4','$unit4','$camera4','$model4','$shutter4','$aperture4','$iso4','$focal4','$gallery','$lat4','$lon4','$datetime','$clean_url4','$clean_thumb4')";
...
$query5="INSERT INTO gal_images (url, thumb, navn, tekst, fotograf, dato, bruker, ip, type, nummer, kamera, kameramodel, lukkertid, blender, iso, focal, posthylla, latitude, longitude, timestamp, clean_url, clean_thumb) VALUES ('$url5','$thumb5','$newfile5','$tekst5','$photographer5','$date5','$user','$ip','$type5','$unit5','$camera5','$model5','$shutter5','$aperture5','$iso5','$focal5','$gallery','$lat5','$lon5','$datetime','$clean_url5','$clean_thumb5')";
...
<script>parent.location.href='subpage.php?s=51';</script>
<?php } 
