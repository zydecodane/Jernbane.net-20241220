...
$ispremiumclass = $db2->query("select 1 AS tender from xf_user_group_relation where (user_group_id =14 or user_group_id = 3) and user_id = '$userid'")->fetch_object()->tender;    
} else {
	$username = 'not logged in';
	$loggedin = 0;
}
...
<li><a href="<?php echo $path; ?>subpage.php?s=1&l=490">Train Tech</a>
 ...
 <?php
?>
<li><a href="<?php echo $path; ?>subpage.php?s=1&amp;l=42">Vogntog</a>
<ul>
<?php
...
// Maritim meny
             ?>
                             <li><a href="subpage.php?s=1&l=59">Maritime Hjørnet</a>
                             <ul>
                               <li><a href="<?php echo $path; ?>subpage.php?s=1&amp;l=59">Det Maritime Hjørnet</a></li>
  ...
  <li><a href="<?php echo $path; ?>subpage.php?s=1&l=433">Aviation</a>
  <ul>
    <li><a href="<?php echo $path; ?>subpage.php?s=1&l=433">Aviation</a></li>
  </ul>
    </li>
  <?php
...
?>
			...
			<li><a href="<?php echo $path; ?>subpage.php?s=61">Medlemsider - FAQ</a>
				<ul>
                  <li><a href="<?php echo $path; ?>subpage.php?s=16">Regler på Jernbane.Net</a></li>
                  <li><a href="<?php echo $path; ?>subpage.php?s=12">Om opphavsrett.</a></li>
                  <li><a href="<?php echo $path; ?>subpage.php?s=13">Donasjoner til driften</a></li>
                  <li><a href="<?php echo $path; ?>subpage.php?s=2&k=1699">Jernbane.Net [FAQ]</a></li>
                  <li><a href="<?php echo $path; ?>subpage.php?s=2&k=1638">Historisk FAQ</a></li>
                  <li><a href="<?php echo $path; ?>subpage.php?s=2&k=1637">Bildebehandling</a>
  ...
  ?>               <li><a href="<?php echo $path; ?>subpage.php?s=1&l=1">Innhold flyttet</a>
                   <ul>
                   <a href="<?php echo $path; ?>subpage.php?s=1&l=3">Danmark</a>
                   <a href="<?php echo $path; ?>subpage.php?s=1&l=2">Sverige</a>
...
<?php
?>
            <li><a href="<?php echo $path; ?>subpage.php?s=1&l=1">Siden flyttet</a></li>
<?php
	...
	?>
			<li><a href="#">ADMIN</a>
			 <ul>
				...
				<li><a href="<?php echo $path; ?>admin/index.php?s=15">Rett tekst på bilde</a></li>
                ...
                <li><a href="<?php echo $path; ?>admin/index.php?s=8">Registreringslogg</a></li>
